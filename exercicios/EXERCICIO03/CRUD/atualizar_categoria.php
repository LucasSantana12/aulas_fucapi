...
$cat->loadById($_POST['idCategoria']);
...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <form class="container" method="post" action = "atualizar_categoria.php"> 

      <div class="form-group">
    <label>ID da categoria</label>
    <input type="text" class="form-control" id="idCategoria" name="idCategoria" readonly=true value = "<?php
    echo $cat->getIdcategoria(); ?>">
  </div>

  <div class="form-group">
    <label>Nome da categoria</label>
    <input type="text" class="form-control" id="produto" name="categoria" required=true value = "<?php
    echo $cat->getcategoria(); ?>">
  </div>
